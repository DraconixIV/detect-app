...
export function createHighlightedIcon(color, size = "medium") {
  ...
  // Premium highlighted gold-edged pin (100% static vector SVG, native L.Icon, zero animation, zero lag, exact anchor)
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg"
         width="${dim.w}"
         height="${dim.h}"
         viewBox="0 0 25 41">
      <!-- Outer Golden Accent Stroke -->
      <path
        d="M12.5 0C5.6 0 0 5.6 0 12.5
           c0 9.4 12.5 28.5 12.5 28.5
           S25 21.9 25 12.5
